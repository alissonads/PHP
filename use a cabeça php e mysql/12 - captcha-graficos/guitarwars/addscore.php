...
<html lang="en">
    ...
    <body>
            ...
            if (isset($_POST['submit'])) {
                ...
                */
                ...
                if ($_SESSION['pass_phrase'] == $user_pass_phrase) {
                    ...
                    echo '<p class="error">Por favor, digite o código de verificação exatamente como mostra.</p>';
                }
        ...
        <form enctype="multipart/form-data" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            ...
            <input type="text" name="verify" id="verify" placeholder="Entre com o código.">
            <img src="scripts/captcha.php" alt="Verification pass-phrase" />
            <hr/>
